...
def build_c_library():
    ...
    try:
        ...
        print(f"Build failed with error code {e.returncode}: {e.stderr}", file=sys.stderr)
        return None
    except FileNotFoundError:
        print("GCC not found in PATH, skipping C compilation. Pure-Python fallback will be used.", file=sys.stderr)
        return None
