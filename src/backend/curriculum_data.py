        ...
        "courses": [
            ...
            },
            {
                ...
                "topics": [
                    {
                        "name": "Wave Optics",
                        "subtopics": ["Interference", "Diffraction", "Polarization", "Newton's Rings"],
                        "important_points": ["Young's Double Slit", "Fraunhofer Diffraction", "Malus Law"],
                        "formulas": ["λ = ax/D", "I = I₀ cos²θ"],
                        "practice_questions": 18
                    },
                    {
                        "name": "Quantum Mechanics Basics",
                        "subtopics": ["Wave-Particle Duality", "Uncertainty Principle", "Schrödinger Equation"],
                        "important_points": ["de Broglie Wavelength", "Heisenberg Uncertainty", "Wave Function"],
                        "formulas": ["λ = h/p", "ΔxΔp ≥ ℏ/2"],
                        "practice_questions": 15
                    }
                ]
            },
